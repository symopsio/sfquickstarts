...
id: clinical-data-analysis-with-adam-and-sdtm-in-snowflake
summary: Understanding clinical trial data is critical for pharmaceutical research and regulatory compliance, but analyzing standardized datasets across multiple formats can be challenging.
...
Understanding clinical trial data is critical for pharmaceutical research and regulatory compliance, but analyzing standardized datasets across multiple formats can be challenging. In this solution, you will use Snowpark to efficiently process ADaM (Analysis Data Model) and SDTM (Study Data Tabulation Model) datasets directly within Snowflake. This solution template allows you to leverage Snowpark's Python capabilities to read clinical data in multiple formats to perform comprehensive analysis without moving data outside Snowflake's secure environment.

### Overview

This solution demonstrates how to build a complete clinical data processing workflow entirely within Snowflake. You'll process standardized clinical datasets, implementing data ingestion, transformation, and analysis stages.This solution showcases how to build an end-to-end clinical data workflow, including:

* Reading clinical data in multiple formats (SAS .sas7bdat, XPT, JSON)
* Processing ADaM datasets (ADSL, ADAE, ADVS, etc.) using Snowpark
* Creating standardized tables and views for clinical analysis
* Querying combined clinical attributes for insights

### Solution Architecture: Clinical Data Processing in Snowflake

The solution walks through how to:

1. Process Multiple Clinical Data Formats

* **SAS Format (.sas7bdat)**: Process binary SAS files from r4csr ADaM datasets
* **XPT Format (.xpt)**: Handle SAS Transport files from CDISC pilot projects
* **JSON Format (.json)**: Parse standardized JSON clinical data

2. Create Clinical Analytics

* Transform raw clinical data into Snowflake tables
* Build comprehensive views combining subject-level data with clinical events
* Enable efficient querying across multiple datasets

### About the Architecture

* **Data** **Ingestion**: Secure upload of clinical files to Snowflake stages
* **Format** **Processing**: Native handling of SAS, XPT, and JSON formats using Snowpark
* **Analytics** **Layer**: Views and tables optimized for clinical insights
* **Governance**: Built-in security and compliance for regulatory requirements

### Data Sources

* **r4csr** **ADaM** **datasets**: Standardized analysis datasets in SAS format
* **CDISC** **Pilot** **Project**: Official pilot submission package with XPT and JSON formats

### Use Cases

* **Regulatory** **Submissions**: Process clinical data for FDA/EMA submissions
* **Safety** **Analysis**: Analyze adverse events across multiple studies
* **Efficacy** **Analysis**: Combine demographics with clinical outcomes
* **Data** **Integration**: Merge multiple clinical datasets for comprehensive analysis
