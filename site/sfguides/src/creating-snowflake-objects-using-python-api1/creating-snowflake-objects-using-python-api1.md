...
id: creating-snowflake-objects-using-python-api1
summary: The Snowflake Python API enables developers to manage Snowflake resource objects directly using Python, without relying on SQL or the Snowflake Connector.
categories: snowflake-site:taxonomy/solution-center/certification/certified-solution
environments: web
language: en
status: Published
feedback link: https://github.com/Snowflake-Labs/sfguides/issues
fork repo link: https://github.com/Snowflake-Labs/sfquickstarts/tree/master/site/sfguides/src/creating-snowflake-objects-using-python-api1

# Creating Snowflake Objects, using Python API
<!-- ------------------------ -->
## Overview

The Snowflake Python API enables developers to manage Snowflake resource objects directly using Python, without relying on SQL or the Snowflake Connector.  It supports creating and managing objects such as tables, schemas, warehouses, users and tasks using Python code. The API also allows interaction with Snowpark Container Services for more advanced use cases. It is designed for users familiar with Python and tools like Jupyter notebooks and  offers a streamlined way to build and automate workflows in Snowflake. This approach simplifies development and enhances productivity within a Python-native environment.
